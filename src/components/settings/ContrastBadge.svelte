...
{#if !passing}
  <span
    class="inline-flex items-center gap-0.5 rounded-sm px-1 py-px text-[0.58rem] font-bold"
    style="background: rgba(248,113,113,0.18); color: var(--danger); border: 1px solid rgba(248,113,113,0.35);"
