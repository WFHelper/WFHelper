...
{#if !passing}
  <span
    class="inline-flex items-center gap-0.5 rounded-[2px] px-1 py-px text-xs font-bold bg-[rgba(248,113,113,0.18)] text-danger border border-[rgba(248,113,113,0.35)]"
